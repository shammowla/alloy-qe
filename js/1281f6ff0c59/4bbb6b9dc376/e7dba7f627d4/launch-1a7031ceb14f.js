(function() {
  ...
  window._satellite.container = {
    buildInfo: {
      buildDate: "2020-09-15T22:43:21Z",
    ...
    extensions: {
      "adobe-target-v2": {
          ...
          "adobe-target-v2/lib/modules/libs/at-launch.js": {
            script: function(module, exports, require, turbine) {
              ...
              var parseUri = function parseURI(str, opts) {
                ...
                var m = o.parser[opts.strictMode ? "strict" : "loose"].exec(
                  str
                );
                var uri = {};
                var i = 14;
              ...
              function extractQaMode(queryString) {
                ...
                if (isNotBlank(trueAudiences)) {
                  result.evaluateAsTrueAudienceIds = extractAudienceIds(
                    trueAudiences
                  );
                }
                var falseAudiences = query[FALSE_AUDIENCE_IDS];
                if (isNotBlank(falseAudiences)) {
                  result.evaluateAsFalseAudienceIds = extractAudienceIds(
                    falseAudiences
                  );
                }
                ...
                var _options$consumerId = options.consumerId,
                  consumerId =
                    _options$consumerId === void 0
                      ...
                      : _options$consumerId,
                  request = options.request;
                var validationResult = validateSendNotificationsOptions(
                  options
                );
                var error = validationResult[ERROR];
                if (!validationResult[VALID]) {
        ...
        hostedLibFilesBaseUrl:
          "/js/1281f6ff0c59/4bbb6b9dc376/e7dba7f627d4/hostedLibFiles/EP269792aa7319457ea7dd670d3f2f68e5/"
      },
      core: {
        displayName: "Core",
        modules: {
        ...
        hostedLibFilesBaseUrl:
          "/js/1281f6ff0c59/4bbb6b9dc376/e7dba7f627d4/hostedLibFiles/EP2e2f86ba46954a2b8a2b3bb72276b9f8/"
      },
      "adobe-analytics": {
        ...
        hostedLibFilesBaseUrl:
          "/js/1281f6ff0c59/4bbb6b9dc376/e7dba7f627d4/hostedLibFiles/EPbde2f7ca14e540399dcc1f8208860b7b/"
      },
      "aam-dil-extension": {
                  ...
                  s = {
                    ...
                    init: function(e, t, s, n) {
                      try {
                        ...
                        var r = e;
                        return (
                          (window.AppMeasurement_Module_DIL = r.m_DIL = function(
                            e
                          ) {
                            var t =
                              "function" == typeof e.m_i ? e.m_i("DIL") : this;
                            ...
                            (t.trackVars = f.constructTrackVars(s)),
                              ...
                              (t._t = function() {
                                ...
                                if (a.d) {
                                  ...
                                  f.includeContextData(d, l).store_populated &&
                                    (h = !0),
        ...
        hostedLibFilesBaseUrl:
          "/js/1281f6ff0c59/4bbb6b9dc376/e7dba7f627d4/hostedLibFiles/EP4e83caf1f501401c8757a221425cd7c8/"
      },
      "adobe-mcid": {
                ...
                var e = (function() {
                    ...
                    (e.fetchConsentData = function(e) {
                      ...
                      (e.isApproved = function(e) {
                        ...
                        if (i.transparencyAndConsentData)
                          return t(
                            null,
                            h(i.transparencyAndConsentData, fe[n], pe[n])
                          );
                  ...
                  var I,
                    ...
                    N = function() {
                      ...
                      Object.keys(w).forEach(n, this),
                        Object.keys(F).forEach(i, this);
                    },
                    x = T.ASYNC_API_MAP,
                    j = function() {
                    ...
                    $ = {
                      ...
                      set: function(e, t, n) {
                        ...
                        if (a && "SESSION" !== r && "NONE" !== r) {
                          ...
                          if (u)
                            (a = new Date()), a.setTime(a.getTime() + 1e3 * u);
                          else if (1 === a) {
                            a = new Date();
                            var l = a.getYear();
                    ...
                    oe = function(e, t) {
                      ...
                      return {
                        ...
                        messagesPosted: [],
                        messagesReceived: [],
                        messageSendingInterval: ae.POST_MESSAGE_ENABLED
                          ? null
                          : 100,
                        ...
                        checkFirstPartyCookie: function(t, n, i) {
                          ...
                          var o,
                            ...
                            l = !1,
                            d = Math.ceil(
                              new Date().getTime() / ae.MILLIS_PER_DAY
                            );
                          c
                            ? ((o = c.split("*")),
                        ...
                        canMakeSyncIDCall: function(t, n) {
                          return (
                            e._forceSyncIDCall ||
                            !t ||
                            n - t > ae.DAYS_BETWEEN_SYNC_ID_CALLS
                          );
                        },
                    ...
                    Oe = function(e) {
                      ...
                      return (
                        ...
                        Ae(e).every(function(e) {
                          return (
                            me.indexOf(e) > -1 || (t && ge.indexOf(e) > -1)
                          );
                        })
                      );
                    },
                    ...
                    Pe = function(e) {
                      return (
                        void 0 === e || (Re(e) ? Oe(Object.keys(e), !0) : Le(e))
                      );
                    },
                    Le = function(e) {
                      try {
                    ...
                    Re = function(e) {
                      return (
                        null !== e && ye(e, "object") && !1 === Array.isArray(e)
                      );
                    },
                    we = function() {},
                    Fe = function(e) {
                  ...
                  var Be = Object.freeze({ OptIn: p, IabPlugin: _ }),
                    ...
                    Xe = Be.OptIn;
                  V.defineGlobalNamespace(),
                    (window.adobe.OptInCategories = Xe.Categories);
                  var Ke = function(t, n, i) {
                    ...
                    function o(e) {
                      function t(e, t, n) {
                        e &&
                          e.match(ae.VALID_VISITOR_ID_REGEX) &&
                          (n === E && (A = !0), t(e));
                      }
                    ...
                    function l() {
                      return (
                        !!I.configs.doesOptInApply &&
                        !(S.optIn.isComplete && d())
                      );
                    }
                    function d() {
                    ...
                    (O.version = I.version),
                      ...
                      (I.loadTimeout = 3e4),
                      (I.CORSErrors = []),
                      (I.marketingCloudServer = I.audienceManagerServer =
                        "dpm.demdex.net"),
                    ...
                    (I.FIELDS = T.FIELDS),
                      ...
                      (I.cookieWrite = function(e, t, n) {
                        var i = I.cookieLifetime
                            ? ("" + I.cookieLifetime).toUpperCase()
                            : "",
                          r = !1;
                        return (
                          I.configs &&
                      ...
                      (I.getMarketingCloudVisitorID = function(e, t) {
                        ...
                        var n = I._getAudienceManagerURLData(
                    ...
                    (I.getVisitorValues = function(e, t) {
                      ...
                      (I.getAnalyticsVisitorID = function(e, t, n) {
                        ...
                        if (
                          ...
                          if (r) {
                            var s =
                              ...
                              c =
                                ...
                                (I.idSyncDisable3rdPartySyncing ||
                                I.disableThirdPartyCookies
                                  ? "&d_coppa=true"
                                  : ""),
                              u = [
                                "s_c_il",
                          ...
                          return (
                            (o.url = a),
                            I._getRemoteField(n ? E : R, a, e, t, o)
                          );
                        }
                        return "";
                      }),
                      ...
                      (I.getSupplementalDataID = function(e, t) {
                        ...
                        return (
                          I._supplementalDataIDLast &&
                          !I._supplementalDataIDLastConsumed[e]
                            ...
                            : n &&
                              (I._supplementalDataIDCurrentConsumed[e] &&
                                ...
                                (I._supplementalDataIDLastConsumed =
                                  I._supplementalDataIDCurrentConsumed),
                                (I._supplementalDataIDCurrent = n = t
                                  ? ""
                                  : I._generateID(1)),
                                (I._supplementalDataIDCurrentConsumed = {})),
                              n &&
                                (I._supplementalDataIDCurrentConsumed[e] = !0)),
                          n
                        );
                      });
                    var U = !1;
                    (I._liberatedOptOut = null),
                      (I.getOptOut = function(e, t) {
                        ...
                        if (
                          ...
                          return (
                            I._callAllCallbacks("liberatedOptOut", [
                              I._liberatedOptOut
                            ]),
                            (U = !1),
                            I._liberatedOptOut
                        ...
                        return (
                          ...
                          (C[r] = function(e) {
                            ...
                            I._callAllCallbacks("liberatedOptOut", [t]),
                              (U = !1);
                          }),
                          j.fireCORS(n),
                          null
                      ...
                      (I._attemptToPopulateIdsFromUrl = function() {
                        ...
                        if (e && e.TS) {
                          var n = B.getTimestampInSeconds(),
                            i = n - e.TS;
                          if (
                            Math.floor(i / 60) > ae.ADOBE_MC_TTL_IN_MIN ||
                            e.MCORGID !== t
                          )
                            return;
                          o(e);
                      ...
                      (I._getSettingsDigest = function() {
                        if (!I._settingsDigest) {
                          var e = I.version;
                          I.audienceManagerServer &&
                            (e += "|" + I.audienceManagerServer),
                        ...
                        if (!I._readVisitorDone) {
                          ...
                          !I._getField(R) &&
                            ...
                            c.length > 1 &&
                              ...
                              i &&
                                i.match(ae.VALID_VISITOR_ID_REGEX) &&
                                I._setField(R, i)));
                        }
                      }),
                      ...
                      (I._findVisitorID = function(t) {
                        return (
                          t &&
                            ...
                            (t &&
                              (t === N ||
                                t.match(ae.VALID_VISITOR_ID_REGEX))) ||
                              (t = "")),
                          t
                        );
                      }),
                        ...
                        if (d() && I.isAllowed()) {
                          ...
                          if (
                            (function() {
                              return (
                                (!o ||
                                  (I._fieldsExpired && I._fieldsExpired[e])) &&
                          ...
                          var p =
                            ...
                            g =
                              ...
                              (D && -1 !== p.indexOf("demdex.net")
                                ...
                                : "") +
                              "&d_rtbd=json&d_ver=2" +
                              (!i && I._use1stPartyMarketingCloudServer
                                ? "&d_verify=1"
                                : "") +
                              "&d_orgid=" +
                              encodeURIComponent(I.marketingCloudOrgID) +
                        ...
                        (function() {
                          if (B.isObject(n)) {
                            (I.idSyncContainerID = I.idSyncContainerID || 0),
                              ...
                              I.resetBeforeVersion &&
                                I._resetAmcvCookie(I.resetBeforeVersion),
        ...
        hostedLibFilesBaseUrl:
          "/js/1281f6ff0c59/4bbb6b9dc376/e7dba7f627d4/hostedLibFiles/EP6437fa78ab024946a211397689052381/"
      }
    },
    company: {
      orgId: "97D1F3F459CE0AD80A495CBE@AdobeOrg"
